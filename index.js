...
window.onload = function () {
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyBQXsZH-Gj5D0TJjbUD1cR_DASLkEKRL5g",

    authDomain: "chatthing-cedfb.firebaseapp.com",

    projectId: "chatthing-cedfb",

    storageBucket: "chatthing-cedfb.appspot.com",

    messagingSenderId: "297411897691",

    appId: "1:297411897691:web:749a0e7abf4f595797d27e",

    measurementId: "G-NY03T9X4SX",
  };
  // Initialize Firebase
      ...
      chat_input.onkeyup = function () {
        if (chat_input.value.length > 0) {
          ...
          chat_input.addEventListener("keydown", function (e) {
            if (e.key === "Enter") {
              chat_input_send.onclick(); // reuse the same function u already got
            }
          });
        } else {
          chat_input_send.classList.remove("enabled");
